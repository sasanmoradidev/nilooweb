...
<div class="product-card">
 ...
 <p><a href="<?php echo get_the_permalink(); ?>" class="product-card-brand-lastprice">
   ...
   <?php if(get_post_meta( get_the_ID(), '_regular_price', true)): ?><span class="product-card-lastprice"><?php echo get_post_meta( get_the_ID(), '_regular_price', true); ?> تومان</span><?php endif; ?>
 </a></p>
 <p><a href="<?php echo get_the_permalink(); ?>" class="product-card-name-price">
   <span class="product-card-name"><?php echo get_the_title(); ?></span>
   <span class="product-card-price"><?php echo get_post_meta( get_the_ID(), '_price', true); ?> تومان</span>
 </a></p>
 <ul class="product-card-size">
  <li><a href="<?php echo get_the_permalink(); ?>"><?php echo $product->get_price_html(); ?></a></li>
 </ul>
</div>
